export default function Context({contextData}) {

   return(
    <ul 
        className={`${contextData.isOpen ? 'context-menu-open': ''} context-menu `}
        style={{
            top: contextData.top + 'px',
            left: contextData.left + 'px'
        }}>
        <li className="context-menu-item">
        <svg xmlns="http://www.w3.org/2000/svg" className="svg" viewBox="0 0 24 24" fill="none">
